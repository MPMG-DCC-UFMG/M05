...
urlpatterns = [
    ...
    path('search_entities/<str:strategy>', views.SearchEntities.as_view(), name='search_entities'),
    path('search_filter/<str:filtro>', views.SearchFilterView.as_view(), name='search'),
