...
from services.models.api_config import APIConfig
...
class Document:
    ...
    def search(self, indices, query, must_queries, should_queries, filter_queries, page_number, results_per_page, sort_by='relevancia', sort_order='desc'):
